...
Materiais de referência e do projeto ServLink usados para elaborar a modelagem UML (PMI III). Arquivos binários (PDF/DOCX) estão versionados com **Git LFS** para visualização no GitHub.

## Estrutura

| Pasta | Conteúdo |
|-------|----------|
| `referencias-pmi/` | Modelos e exemplos da disciplina (Rational Rose, descritivo de use case, entrega PMI III) |
...
- **Modelos dos Diagramas UML para entrega da Documentação PMI III (1).docx** — checklist dos 9 diagramas exigidos
